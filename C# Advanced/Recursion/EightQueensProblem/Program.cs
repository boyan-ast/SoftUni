    ...
    class Program
    {
        ...
        private static bool IsSafe(int[,] queens, int row, int col)
        {
            for (int i = 1; i < queens.GetLength(0); i++)
            {
                ...
                else if (col - i >= 0 && queens[row, col - i] == 1)
                {
                    return false;
                }
                else if (row + i < queens.GetLength(0) && queens[row + i, col] == 1)
                {
                    return false;
                }
                else if (col + i < queens.GetLength(1) && queens[row, col + i] == 1)
                {
                    return false;
                }
                else if (col + i < queens.GetLength(1) &&
